...
INSERT INTO ma_user_roles (id, role) VALUES (1,'ADMIN');
INSERT INTO ma_user_roles (id, role) VALUES (2,'BACK_OFFICE_EMPLOYEE');
INSERT INTO ma_user_roles (id, role) VALUES (3,'REMOTE_SELLER_STAFFER');
INSERT INTO ma_user_roles (id, role) VALUES (4,'SALES_AGENT_FREELANCER');
INSERT INTO ma_user_roles (id, role) VALUES (5,'SALES_AGENT_FREELANCER_LEAD_GEN');
--
-- Data for Name: ds_user; Type: TABLE DATA; Schema: public; Owner: magent
--
/*user1 pass testUser*/
INSERT INTO ma_user (id, enabled, login,  u_role, first_name, last_name, e_mail)
...
INSERT INTO ma_user_personal(user_pers_id, usr_pers_pwd, ma_usr_id)  VALUES (1,'63874c0f0b6ba858cc832af759ca4954c2c84d4f',1);
INSERT INTO ma_user_personal(user_pers_id, usr_pers_pwd, ma_usr_id)  VALUES (2,'63874c0f0b6ba858cc832af759ca4954c2c84d4f',2);
INSERT INTO ma_user_personal(user_pers_id, usr_pers_pwd, ma_usr_id)  VALUES (3,'63874c0f0b6ba858cc832af759ca4954c2c84d4f',3);

INSERT INTO ma_sms_pass(smsid, sms_password, sms_user_id,endperiod) VALUES (1,'ef9ff97e3bd1408eac6f802186af89da55eb184d',1,'2016-01-01');
...
INSERT INTO ma_transactions (id, account_number, is_increment_operation, transactioon_summ, transaction_date)
...
INSERT INTO ma_device (id, googleid, lastchange) VALUES ('d6190a7e8aea17ad',
                                                         ...
                                                         NULL);
INSERT INTO ma_device (id, googleid, lastchange) VALUES ('f628c95c83390329',
...
INSERT INTO ma_reason (id, parent_id, description, name) VALUES (1, NULL, 'По вине клиента', 'По вине клиента');
INSERT INTO ma_reason (id, parent_id, description, name) VALUES (2, NULL, 'По вине агента', 'По вине агента');
INSERT INTO ma_reason (id, parent_id, description, name) VALUES (3, 1, 'По вине клиента child', 'По вине клиента');

--
-- Data for Name: ds_template; Type: TABLE DATA; Schema: public; Owner: magent
--

INSERT INTO ma_template (id, name, description) VALUES (1, 'Кредитная карта', 'Кредитная карта "Кредитка"');
INSERT INTO ma_template (id, name, description) VALUES (2, 'Кредитная карта For Delete', 'Кредитная карта "Кредитка"');

--
-- Data for Name: ds_template_attribute; Type: TABLE DATA; Schema: public; Owner: magent
--

INSERT INTO ma_template_attribute (id, template_id, description, value_type, editable, required)
...
INSERT INTO ma_template_tasks (id, template_id, description, priority, required) VALUES (1, 1, 'Паспорт', 1, TRUE);
INSERT INTO ma_template_tasks (id, template_id, description, priority, required) VALUES (2, 1, 'ИНН', 2, TRUE);
INSERT INTO ma_template_tasks (id, template_id, description, priority, required) VALUES (3, 1, 'Опросник ФЛ', 3, TRUE);

--
-- Data for Name: ds_task_controls; Type: TABLE DATA; Schema: public; Owner: magent
--

INSERT INTO ma_template_task_controls (id, template_task_id, description, value_type, validation_rule, priority, required)
...
INSERT INTO ma_assignment (id, template_id, user_id, datestart, dateend, deadline, description, latitude, longitude, lastchange, reason_id, status, version)
...
INSERT INTO ma_assignment_attribute (id, assignment_id, description, value_type, editable, attr_value, lastchange, required, visible)
...
INSERT INTO ma_assignment_attribute (id, assignment_id, description, value_type, editable, attr_value, lastchange, required)
...
INSERT INTO ma_assignment_tasks (id, assignment_id, description, lastchange, priority, required, version)
...
INSERT INTO ma_assignment_task_controls (id, assignment_task_id, description, value_type, validation_rule, lastchange, required, control_value, priority)
...
INSERT INTO ma_call (id, assignment_id, device_id, user_id, call_date, call_duration, call_number, call_type, contact_name, lastchange)
...
INSERT INTO ma_location (id, device_id, user_id, location_date, latitude, longitude)
...
INSERT INTO ma_activity (id, device_id, user_id, app_date, app_duration, app_name, version)
...
INSERT INTO ma_settings (id, user_id, is_upload_apps, is_upload_calls, is_upload_location, upload_stats_start_time, upload_stats_stop_time)
