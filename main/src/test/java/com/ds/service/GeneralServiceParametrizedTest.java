...
import com.ds.config.DistanceSalesDummyServiceTestConfig;
...
public class GeneralServiceParametrizedTest {
    private static final ApplicationContext context= new AnnotationConfigApplicationContext(DistanceSalesDummyServiceTestConfig.class);
