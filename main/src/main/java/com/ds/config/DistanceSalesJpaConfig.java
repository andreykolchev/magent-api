...
@ComponentScan({"com.ds.repository", "com.ds.service, com.ds.domain"})
@EnableJpaRepositories(value = "com.ds.repository", repositoryFactoryBeanClass = EnversRevisionRepositoryFactoryBean.class)
@PropertySources({
        @PropertySource("classpath:distancesales.properties"),
        //@PropertySource(value = "file:/opt/esb/config/distancesales.properties", ignoreResourceNotFound = true)
})
public class DistanceSalesJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.ds.domain");
